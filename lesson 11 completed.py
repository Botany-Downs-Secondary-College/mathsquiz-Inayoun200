...
class MathQuiz:
    def __init__(self,parent) :
        ...
        self.QuestionsLabel = Label(self.Questions, text = "Quiz Questions",
                                    bg = "black", fg = "white", width = 20, padx = 20, pady = 10,
                                    font = ("Time", '14', "bold italic"))
        ...
        #create a scorelabel to display score
    ...
    def next_question(self):
        ...
        y = randrange(10)
        self.answer = x + y
        self.index +=1 #keeps adding to the index number 

        question_text =str(x) + " + " + str(y) + " = "
        self.Problems.configure(text = question_text)
        #updates questionlabel with question number
        self.QuestionsLabel.configure(text = "Quiz Question " + str(self.index)+ "/5")
        #limits number equarions to 5, then remove questions frame and show welcome frame
        if self.index >=6:
            self.Questions.grid_remove()
            self.Welcome.grid()
